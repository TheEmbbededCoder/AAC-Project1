...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------  
          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ADD    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ADDI   R[DR],R[SA],SIMM18
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- SUB    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- SUBI   R[DR],R[SA],SIMM18
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- AND    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ANDIL  R[DR],R[SA],IMM16
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ANDIH  R[DR],R[SA],IMM16
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- NAND   R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- OR     R[DR],R[SA],R[BA]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ORIL   R[DR],R[SA],IMM16
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ORIH   R[DR],R[SA],IMM16
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- NOR    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- XOR    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- XNOR   R[DR],R[SA],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LSL    R[DR],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LSR    R[DR],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ROL    R[DR],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ROR    R[DR],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ASL    R[DR],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ASR    R[DR],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LD     R[DA],(R[AA]+R[BA])
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LDI    R[DA],(R[AA]+SIMM18)
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ST     (R[AA]+SIMM18),R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- B.cond  (R[SA] cond R[SB]),SIMM14
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- BI.cond (R[SA] cond SIMM14),R[SB]
